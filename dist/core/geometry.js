...
import { getElementFromCanvas, updateElementOnCanvas, batchCreateElementsOnCanvas, getElements } from './canvas-client.js';
export async function alignElements(elementIds, alignment) {
    // Fetch all elements
...
export async function distributeElements(elementIds, direction) {
    // Fetch all elements
...
export async function setElementsLocked(elementIds, locked) {
...
export async function groupElements(elementIds) {
...
export async function ungroupElements(groupId, knownMemberIds) {
...
export async function duplicateElements(elementIds, offsetX = 20, offsetY = 20) {
    const duplicates = [];
    for (const id of elementIds) {
