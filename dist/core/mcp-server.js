...
const SERVER_DESCRIPTION = 'Programmatic canvas toolkit for Excalidraw with file I/O, image export, and real-time sync';
...
const STATIC_SURFACE_CACHE_HINT = { ttlMs: 300_000, cacheScope: 'public' };
/**
 ...
 */
export function createExcalidrawMcpServer(ctx) {
    ...
    for (const tool of tools) {
        ...
        }, async (args) => callExcalidrawTool(tool.name, args));
    }
 ...
 */
export const excalidrawMcpServerFactory = ctx => createExcalidrawMcpServer(ctx);
